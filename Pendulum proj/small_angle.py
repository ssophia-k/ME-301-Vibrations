...
#Initial conditions
theta_0 = np.radians(9.958453603)
omega_0 = 0


#Get time-step angles from tracker data
tracker_data = np.genfromtxt('ME-301 Vibrations/Small_angle_data.csv', delimiter=',', skip_header=1)
...
plt.title("IC Response of Ruler Pendulum, Experimental vs model, Theta_0 = 9.96º")
...
plt.xlabel('Time [s]')
plt.ylabel('Angle [deg]')
plt.title("IC Response of Ruler Pendulum, Real behavior vs. idealized, Theta_0 = 9.96º")
