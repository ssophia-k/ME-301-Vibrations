...
'''
#File path
time_data_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker_time_domain.txt'
fft_mag_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker/fft_mag.txt'
fft_phase_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker/fft_phase.txt'
