...
'''
#File path
time_data_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker_lifted/time_domain.txt'
fft_mag_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker_lifted/fft_mag.txt'
fft_phase_file_path = 'Cross Spectrum Final proj/Data/Anechoic_269hz_speaker_lifted/fft_phase.txt'
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic_269hz_speaker_lifted/fft.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic_269hz_speaker_lifted/cross.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic_269hz_speaker_lifted/coherence.png')
