...
'''
#File path
time_data_file_path = 'Cross Spectrum Final proj/Data/Anechoic/time_domain.txt'
fft_mag_file_path = 'Cross Spectrum Final proj/Data/Anechoic/fft_mag.txt'
fft_phase_file_path = 'Cross Spectrum Final proj/Data/Anechoic/fft_phase.txt'
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic/fft.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic/cross.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/anechoic/coherence.png')
