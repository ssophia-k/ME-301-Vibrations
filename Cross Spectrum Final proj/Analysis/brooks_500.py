...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/brooks/fft.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/brooks/cross.png')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Cross Spectrum Final proj/Plots/brooks/coherence.png')
